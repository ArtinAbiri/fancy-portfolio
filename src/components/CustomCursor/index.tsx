...
const CustomCursor = ({speed = 0.1}) => {
    ...
    useEffect(() => {
        const followMouse = () => {
            ...
            const {
                mouseX, mouseY, destinationX, destinationY, distanceX, distanceY,
            } = positionRef.current;
            ...
            if (titleRef && titleRef.current) titleRef.current.style.transform = `translate3d(${destinationX}px, ${destinationY}px, 0)`;
        };
        followMouse();
    }, [speed]);
